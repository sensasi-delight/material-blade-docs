    ...
    <main>
        <x-mbc::grid container>
            <x-mbc::grid colSize="6"
                ...
                <div>
                    <x-mbc::button href="{{ route('getting-started') }}"
                                   label="Get Started"
                                   variant="raised" />
                </div>
            </x-mbc::grid>
                ...
                <x-mbc::grid container
                    ...
                    <x-mbc::grid colSize="6"
                        ...
                        <x-mbc::Card>
                            ...
                            <!-- Header -->
                            <x-mbc::CardHeader title="Our Changing Planet"
                            ...
                            <x-mbc::CardActions>
                                ...
                                <x-slot name="iconButtons">
                                    <x-mbc::IconButton title="Add to favorites"
                                                       aria-label="Add to favorites"
                                                       toggle
                                                       icon="favorite"
                                                       offIcon="favorite_border"
                                                       color="error" />
                                    <x-mbc::IconButton title="Share"
                                                       icon="share" />
                                    <x-mbc::IconButton title="More options"
                        ...
                        <div>
                            ...
                            <x-mbc::button label="Raised"
                                           variant="raised" />
                            <x-mbc::button label="Unelevated"
                                           variant="unelevated" />
                            <x-mbc::button label="Outlined"
                                           variant="outlined" />
                        </div>
                    ...
                    <x-mbc::grid colSize="6"
                        ...
                        <x-MaterialBlade::DataTable :header="$header"
                                                    :data="$data"
                                                    withCheckbox />
                        ...
                        <x-mbc::TabBar :tabs="$tabs"
                                       color="primary"
                                       lightText
                                       elevation="3" />

                        <div>
                            <x-mbc::IconButton toggle
                                               icon="home" />
                            <x-mbc::IconButton toggle
                                               icon="bluetooth"
                                               color="primary" />
                            <x-mbc::IconButton toggle="on"
                                               icon="filter_vintage"
                                               color="secondary" />
                            <x-mbc::IconButton toggle="on"
                                               icon="delete"
                        ...
                        <x-mbc::Card>
                            <div
                                ...
                                <x-mbc::CardMedia src="https://upload.wikimedia.org/wikipedia/en/9/9f/Bohemian_Rhapsody.png"
                                                  style="width: 110px; border-radius: inherit;"
                                                  variant="square">
                                </x-mbc::CardMedia>

                                <div>
                                    <x-mbc::CardHeader title="Bohemian Raphsody"
                                                       subtitle="by Queen" />

                                    <x-mbc::CardActions>
                                        <x-slot name="iconButtons">
                                            <x-mbc::IconButton title="Previous"
                                                               icon="skip_previous" />
                                            <x-mbc::IconButton title="play"
                                                               style="font-size: 3em;"
                                                               icon="play_arrow" />
                                            <x-mbc::IconButton title="Next"
                                                               icon="skip_next" />
                                        </x-slot>
                                    </x-mbc::CardActions>
                                </div>
