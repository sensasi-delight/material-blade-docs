...
@section('description')
    <x-mbc::typography>
        Snackbars provide brief messages about app processes at the bottom of the screen. They appear temporarily, towards
        the bottom of the screen, and shouldn't interrupt the user experience.
    </x-mbc::typography>

    <x-component-preview>
        <x-mbc::snackbar id="snackbar-description" message="This is a basic snackbar message" />
        
        <x-mbc::button label="Show Snackbar" variant="raised" 
            onclick="document.getElementById('snackbar-description').MDCSnackbar.open()" />
    ...
    <x-mbc::typography variant="body2" style="margin-top: 1rem; color: #666;">
        <strong>Note:</strong> In production, snackbars are programmatically opened using JavaScript. The examples on this
        page are displayed for demonstration purposes. Always use the <code>message</code>
        attribute to pass snackbar content.
    </x-mbc::typography>
@endsection
